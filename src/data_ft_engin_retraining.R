...
#save the dataset
write.table(train_X_scale, file = "data/gold/train_X_retrain.csv", sep = ",", row.names = F)
write.table(test_X_scale, file = "data/gold/test_X_retrain.csv", sep = ",", row.names = F)
